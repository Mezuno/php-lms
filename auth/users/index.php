...
<div class="p20 login">
  <div class="p20-bg-rnd-container flex-col">
    ...
    <form method="post" id="reg_form" action="<?= $auth_user_link ?>">
        <input class="login__input" value="<?php if(isset($_SESSION['loginLogin'])) echo $_SESSION['loginLogin'] ?>"
         type="text" id="login" name="login" placeholder="Логин" /><br>
        <input class="login__input mb20" value="<?php if(isset($_SESSION['loginPassword'])) echo $_SESSION['loginPassword'] ?>"
          type="password" id="password" name="password" placeholder="Пароль" /><br>
        <input class="rounded-button login__button" type="submit" name="logbtn" id="logbtn" value="Войти">
    </form>
    ...
    <a class="login__reglink" href="<?= $reg_user_form_link ?>">Регистрация</a>
