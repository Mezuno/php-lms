<div class="pagination">
	<div class="list-lists">
		...
		<?php if(!($_GET['list'] < 5)): ?>
			<a href="/users/list/<?= $_GET['list']-4 ?>"><?= $_GET['list']-4 ?></a>
		<?php endif ?>
		<?php if(!($_GET['list'] < 4)): ?>
			<a href="/users/list/<?= $_GET['list']-3 ?>"><?= $_GET['list']-3 ?></a>
		<?php endif ?>
		<?php if(!($_GET['list'] < 3)): ?>
			<a href="/users/list/<?= $_GET['list']-2 ?>"><?= $_GET['list']-2 ?></a>
		<?php endif ?>
		<?php if(!($_GET['list'] < 2)): ?>
			<a href="/users/list/<?= $_GET['list']-1 ?>"><?= $_GET['list']-1 ?></a>
		<?php endif ?>

			<a class="red" href="/users/list/<?= $_GET['list'] ?>"><?= $_GET['list'] ?></a>
